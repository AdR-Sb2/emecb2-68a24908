...
- A aba Atendimentos NAO renderiza as ~32 mil linhas de uma vez: lista paginada no cliente (`limiteVisiveis` inicia em 100, "Carregar mais" +200, reset a cada filtro/busca via efeito em `atendimentosFiltrados`). Sem isso o browser trava e a busca parece nao funcionar.
