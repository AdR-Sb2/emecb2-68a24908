...
export const PLANTAS_BAIXADA_1: string[] = ["PL-RJB-EAB0001", "PL-RJB-EAT0105"];

// (f) Outra SUP — PLANTAS (contém substring)
export const PLANTAS_OUTRA_SUP: string[] = ["PL-RJA-EAT0063"];
...
export const TEXTO_BREVE_NAO_ATENDEMOS: string[] = ["PV MEC - VÁLVULA VENTOSA"].map(normStr);

// (k) Não atendemos — PLANTAS (contém substring)
export const PLANTAS_NAO_ATENDEMOS: string[] = ["PL-RJB-ETR0582"];
...
export const EQUIP_EMEC: string[] = [
  "BOMBA CENTRÍFUGA",
  "PAINEL ELÉTRICO COMANDO OU DISTRIBUIÇÃO",
  "INVERSOR DE FREQUÊNCIA",
  "BOMBA CENTRIFUGA SUBMERSÍVEL",
  "MOTOR ELÉTRICO",
  "BANCO CAPACITOR",
  "GRADEAMENTO AUTOMÁTICO",
  "REDUTOR MECÂNICO DE VELOCIDADE",
  "SOFT STARTER",
  "BOMBA VERTICAL",
  "BOMBA CENTRIFUGA MULTIESTÁGIO SUBMERSA",
  "COMPRESSOR",
  "SOPRADOR",
  "BOMBA HORIZONTAL BIPARTIDA",
  "MOTOREDUTOR",
  "GERADOR",
  "BOMBA CENTRIFUGA MULTIESTÁGIO",
  "BOMBA CENTRÍFUGA AUTOESCORVANTE",
  "ROSCA TRANSPORTADORA HELICOIDAL",
...
export function computeEquipe(row: {
  ...
  if (typeof console !== "undefined") {
    console.warn(
      `[Backlog] Equipamento sem match em Baixada 2: "${row.descricaoEquipamento}" (OM ${om})`,
    );
  }
