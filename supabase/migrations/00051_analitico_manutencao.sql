-- ============================================================
-- Migration: Analítico de Manutenção (Preventiva x Corretiva)
-- ============================================================

-- 1. Analítico por elevatória (janela parametrizada em meses)
...
-- 2. Tendência mensal (preventiva válida x corretiva), agregada por mês
CREATE OR REPLACE FUNCTION analitico_tendencia_mensal(ultimos_meses integer DEFAULT 24)
RETURNS TABLE (
  mes text,
  preventiva bigint,
  corretiva bigint
