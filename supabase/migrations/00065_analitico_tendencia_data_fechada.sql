-- ============================================================
-- Migration: Tendência mensal pela data de fechamento da nota
-- ============================================================
-- Coluna W do SAP 'Data de modif.mestre ordens'
-- (registros_atendimento.data_modificacao) é a data de encerramento
-- da O.S. A tendência mensal passa a agrupar por
-- COALESCE(data_modificacao, data_entrada), igual às demais funções
-- do Analítico (migration 00064).
